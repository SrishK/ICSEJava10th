...

{
    ...
    
    {
        ...
        while(infinity>0)
        {
            ...
            System.out.println("=======================");
            System.out.println("");
            System.out.print("Enter Your Name: ");//Taking name as input
            name=sc.nextLine();
                ...
                //List of rules and regulations for the game
                ...
                for(c=0;c<=2;c++) 
                {
                 ...
                 {
                    System.out.println("");
                    System.out.print("Enter Your Number: ");//User's enters the number
                    bb=Integer.parseInt(sc.nextLine());
                    rr=((Math.random())*10);//random which the computer will use
                    rr=rr+1;
                    aa=(int)(rr);
                    System.out.println("");
                    ...
                    if(bb==aa)//Checking if user is out
                    {
                        System.out.println(" ");
                    ...
                    else if(bb>0&&bb<=10) //Calculating score of user
                    { 
                        score1=score1+bb; 
                    } 
                    else if(bb>10||bb<=0)//Checking if the input is wrong
                    {
                        for(c=0;c<=2;c++)
                        {
                            System.out.println("====================================");
                ...
                for(c=0;c<=2;c++) 
                { 
                    //Ending user's batting because user cheated
                    if(cheat>0)
                    {
                        break;
                    }
                ...
                { 
                    ...
                    System.out.println("YOU ARE BOWLING:");//User is now bowling
                }
                ...
                for(ii=1;ii>0;ii++)
                {
                    ...
                    System.out.println("");
                    System.out.print("Enter Your Number: ");//User enters number for bowling
                    bb=Integer.parseInt(sc.nextLine());
                    rr=((Math.random())*10);//Computer's number for batting
                    rr=rr+1;
                    aa=(int)(rr);
                    System.out.println("");
                    System.out.println("Computer's Number: "+aa);
                    ...
                    if(aa==bb)//Checking if computer is out
                    {
                        System.out.println(" ");
                    ...
                    { 
                        score2=score2+aa; //Calculating the score of the Computer
                    } 
                    else if(bb>10||bb<=0)
                    {
                        for(c=0;c<=2;c++) 
                        ...
                        System.out.println("You have either tried to cheat or entered a wrong input. Game Over!");//Checking if user has cheated 
                        cheat++; 
                        break; 
                    } 
                    if(score2>score1)//if computer has scored more than user
                    {
                        System.out.println(" ");
                    ...
                    System.out.println("Computer's Current Score Is "+score2);//Displaying computer's current score
                    System.out.println("");
                    System.out.println("****");
                }
                ...
                { 
                    ...
                    //Displaying user's and computer's final score
                    System.out.println(" ");
                    System.out.println("################");
                    System.out.println("################");
                    System.out.println("YOUR FINAL SCORE = "+score1);
